...
const launcher=()=>{
    jQuery("#loader_page").fadeOut(0, ()=>{
        jQuery("#home").fadeTo(3000,1, ()=>{
            home_changer()
        })
    })
}
